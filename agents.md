...
Privacy policy: public-safe profile. Phone and address are not duplicated here; consult the downloadable resume only when a human reviewer needs full resume contact details.

## Primary Documents

- Human portfolio: `index.html`
- Agent page: `agents.html`
- Structured JSON: `agents.json`
- Resume PDF: `docs/Tyler-Resume.pdf`
- Technical briefs PDF: `docs/Tyler-Technical-Briefs.pdf`
